...
def solve_sliding_puzzle(master, output, height, width):
    ...
    while True: 
        temp = last_sols.flatMap(bfs_map) 
        temp2 = all_sols + last_sols
        length_before = temp2.count()
        temp3 = temp2.reduceByKey(bfs_reduce)
        length_after = temp3.count()
    ...
    all_sols.coalesce(1).saveAsTextFile(output)
